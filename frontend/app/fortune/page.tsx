          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <motion.div 
                ...
                className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-indigo-600 to-indigo-700 rounded-full flex items-center justify-center shadow-lg shadow-indigo-500/50"
              >
              ...
              >
                Khám phá vận mệnh theo truyền thống Á Đông
              </motion.p>
            </motion.div>
            ...
            >
              ...
              >
                <Button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-lg font-medium whitespace-nowrap shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50"
                >
                {isAnalyzing ? (
                  <>
